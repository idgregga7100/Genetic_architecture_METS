...
snpgdsBED2GDS(bed.fn = "/home/isabelle/METS/METS735_rsid_snpfiltered_"%&%pop%&%".bed", 
              bim.fn = "/home/isabelle/METS/METS735_rsid_snpfiltered_"%&%pop%&%".bim", 
              fam.fn = "/home/isabelle/METS/METS735_rsid_snpfiltered_"%&%pop%&%".fam", 
              out.gdsfn = "/home/isabelle/METS/METS735_rsid_snpfiltered_"%&%pop%&%".gds")
...
gdsfile <- "/home/isabelle/METS/METS735_rsid_snpfiltered_"%&%pop%&%".gds"
...
saveRDS(pruned,"/home/isabelle/METS/METS735_rsid_snpfiltered_pruned_set_"%&%pop%&%".RDS")
...
saveRDS(king, file = "/home/isabelle/METS/METS735_rsid_snpfiltered_King_matrix_"%&%pop%&%".RDS")

#Close all previously opened GDS files
showfile.gds(closeall=TRUE)

#Create genotype object needed for pcair function
geno <- GdsGenotypeReader(filename = "/home/isabelle/METS/METS735_rsid_snpfiltered_"%&%pop%&%".gds") 
...
# plot top 2 PCs
png('METS735_rsid_snpfiltered_PC1-2_'%&%pop%&%'.png')
plot(mypcair)
dev.off()
# plot PCs 2 and 3
png('METS735_rsid_snpfiltered_PC2-3_'%&%pop%&%'.png')
...
fwrite(pcairrel,'/home/isabelle/METS/METS735_rsid_snpfiltered_PCAIR_'%&%pop%&%'.txt',sep='\t',quote=F,row.names=F)
